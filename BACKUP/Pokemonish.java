...
//    }
    ...
    public static void play(Deck deck1, Deck deck2)throws Exception{
...
//    then gives prompts for which attack to use
    ...
    public static void start(Pokemon x,Pokemon y,int i){
        ...
        System.out.printf("Player %d's %s Health: %d Type 2 attacks: %d\n",player,x.name,x.health,x.numa2);
        System.out.printf("Player %d's %s Health: %d \n",player2,y.name,y.health);
