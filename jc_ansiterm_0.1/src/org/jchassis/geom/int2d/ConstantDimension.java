 ...
 * </FONT>
 */
public class ConstantDimension extends ConstantPoint implements Dimension {

    /**
     * Creates a new dimension.
     *
     * @param width the x (horizontal) component of the dimension
     * @param height the y (vertical) component of the dimension
     *
    ...
    public ConstantDimension(int width, int height) {
        ...
        if ((width < 0) || (height < 0)) {
            throw new
                IllegalArgumentException("negative component not allowed: "
                                         + "(" + width + "," + height + ")");
        }
    }
