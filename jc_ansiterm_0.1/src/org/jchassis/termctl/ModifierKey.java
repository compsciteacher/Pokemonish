...
/**
 * A representation of a modifier key on a keyboard.
...
public class ModifierKey extends Key {
    ...
    public static final ModifierKey SHIFT   = new ModifierKey("SHIFT");
    public static final ModifierKey CONTROL = new ModifierKey("CONTROL");
    public static final ModifierKey ALT     = new ModifierKey("ALT");

    ModifierKey(String name) {
        super(name);
    }
}
