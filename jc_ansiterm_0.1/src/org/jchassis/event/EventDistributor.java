...
/**
 * An interface for an object that notified one or more listeners.
 *
...
public interface EventDistributor {
   ...
   /**
     * Notifies all listeners of an event with the specified role.
     *
     * @param eventRole the role of the event
     * @param eventData the data associated with the event
     */
    void notifyEventListeners(EventRole eventRole, Object eventData);
}
