...
import org.jchassis.name.Name;

/**
 * The role of an event.
 * The meaning of a role is application-specific.
 *
 ...
 * </FONT>
 */
public class EventRole extends Name {

    /**
     * Creates a new role with the specified name components.
     *
     * @param nameComponents the components of the role's name
     */
    public EventRole(String[] nameComponents) {
        super(nameComponents);
    }
}
